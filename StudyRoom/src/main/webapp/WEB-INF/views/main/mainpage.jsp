...
<img alt="/main/mainpage" src="/resources/main/srfs.PNG" style="padding-left: 25%; padding-top: 100px;">
</a>
<br>
<br>
...
<!-- 		</select>  -->
		...
		<input type="text" class="search-input" name="keyword" onfocus="this.value=''" value='지역/독서실이름 입력하세요<c:out value="${pageMaker.cri.keyword }"/>'> 
