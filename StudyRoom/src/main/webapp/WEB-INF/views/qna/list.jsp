		...
		<div class="panel panel-default">
			...
			<table class="table eable-striped table-bordered table-hover">
				...
				<c:forEach items="${list }" var="qna">
					<tr>
						<td><c:out value="${qna.questionNo }" /></td>
						<td><a class="move" href='<c:out value="${qna.questionNo }" />'>
								<c:out value="${qna.title }" />
						</a></td>
						<td><c:out value="${qna.writer }" /></td>
						<td><fmt:formatDate value="${qna.writedate }"
								pattern="yyyy-MM-dd" /></td>
						<td><fmt:formatDate value="${qna.updatedate }"
								pattern="yyyy-MM-dd" /></td>
					</tr>
				</c:forEach>
			</table>
						...
						$(".move")
								.on(
										...
										function(e) {
											e.preventDefault();
											actionForm
													.append("<input type='hidden' name='questionNo' value='"
															+ $(this).attr(
																	"href")
															+ "'>");
