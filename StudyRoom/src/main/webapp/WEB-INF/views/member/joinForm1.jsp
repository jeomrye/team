...
<input type="hidden" class="memberno_input" name="memberno" value="1" >
...
<input type="hidden" class="companynumber_input" name="companynumber" placeholder="사업자만 입력하세요" value="0">
